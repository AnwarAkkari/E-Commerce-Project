...
public class Product {
	...
	@NotBlank(message = "Product description cannot be blank") // is it ok to create a product and add a description later? or not?
	private String description;

	@PositiveOrZero(message = "Inventory numbers cannot be negative") // but is zero really ok?
	...
	private String image; // image attribute is a string representing the path where the image file is stored
						// is it ok to create a product and add an image file path later? or not?
